...
testers = {
    'erlang': Tester('erlang', '/Users/davisp/github/labs-cloudant/couchdb-erlfdb/test/tester.es', 2040, 600, MAX_API_VERSION, types=ALL_TYPES),
    'python': Tester('python', 'python ' + _absolute_path('python/tests/tester.py'), 2040, 600, MAX_API_VERSION, types=ALL_TYPES),
